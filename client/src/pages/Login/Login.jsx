...
const Login = () => {
  ...
  const refreshCaptcha = () => {
    ...
    resetField('captcha'); // শুধু ফর্ম ফিল্ড ক্লিয়ার
  };

  const onSubmit = (data) => {
    if (data.captcha !== captcha) {
      alert('ক্যাপচা মেলেনি! আবার চেষ্টা করুন।');
      refreshCaptcha();
      return;
    }
          ...
          <div className="max-w-md mx-auto w-full">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <div>
                ...
                {/* এখানে value দরকার নেই – শুধু register */}
                <input
                  type="text"
                  {...register('captcha', {
              ...
              <button
                type="submit"
                className="w-full bg-primary hover:bg-primary/80 text-black cursor-pointer font-semibold py-3 rounded-xl transition duration-300 transform hover:scale-105 shadow-lg"
              >
                Login Now
              </button>
            </form>
